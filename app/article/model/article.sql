...
(
    ...
    article_ctt_head VARCHAR(100) NOT NULL COMMENT '文章内容开头',
...
(
    id               BIGINT      NOT NULL AUTO_INCREMENT COMMENT '自增id',
    article_id       VARCHAR(50) NOT NULL UNIQUE COMMENT '文章id',
    article_ctt_html LONGTEXT    NOT NULL COMMENT '文章html内容',
    article_ctt_md   LONGTEXT    NOT NULL COMMENT '文章markdown内容',
    create_time      DATETIME    NOT NULL DEFAULT CURRENT_TIMESTAMP,
    update_time      DATETIME    NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deleted_time     DATETIME             DEFAULT NULL,
    PRIMARY KEY (id),
    FULLTEXT KEY (article_ctt_html) with parser ngram,
    FULLTEXT KEY (article_ctt_md) with parser ngram
) ENGINE = InnoDB
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci
...
(
    ...
    article_group_id VARCHAR(50) NOT NULL COMMENT '分类目录id',
    article_id       VARCHAR(50) NOT NULL UNIQUE COMMENT '文章id',
    create_time      DATETIME    NOT NULL DEFAULT CURRENT_TIMESTAMP,
    update_time      DATETIME    NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deleted_time     DATETIME             DEFAULT NULL,
